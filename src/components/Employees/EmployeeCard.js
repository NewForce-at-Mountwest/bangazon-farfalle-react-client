           ...
           <div>
               <div className="card" style={{width: "18rem"}}>
                ...
                <div className="card-body">
                    ...
                    {/* <h6>Currently Assigned Computer: {this.props.employee.currentComputer.id}</h6>
                    <p>{this.props.employee.currentComputer.make}</p><p>{this.props.employee.currentComputer.manufacturer}</p> */}
